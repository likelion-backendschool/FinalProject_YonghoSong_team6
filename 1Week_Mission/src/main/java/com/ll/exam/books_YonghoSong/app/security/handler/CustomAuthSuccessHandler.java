package com.ll.exam.books_YonghoSong.app.security.handler;
...
public class CustomAuthSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        /**
         * prevPage 가 존재하는 경우 = 사용자가 직접 /auth/login 경로로 로그인 요청
         * 기존 Session 의 prevPage attribute 제거
         */
         ...
         * Security Filter 가 인터셉트하여 savedRequest 에 세션 저장
         */
